...
class JsonConvert {
  ...
  static Map<String, JsonConvertFunction> get convertFuncMap => {
        ...
        (MySharedDataShareArticles).toString():
            MySharedDataShareArticles.fromJson,
        ...
        (ProjectListDataItemEntity).toString():
            ProjectListDataItemEntity.fromJson,
        (ProjectListDataDatasTags).toString():
            ProjectListDataDatasTags.fromJson,
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<MySharedDataEntity>[] is M) {
      return data
          .map<MySharedDataEntity>(
              (Map<String, dynamic> e) => MySharedDataEntity.fromJson(e))
          .toList() as M;
    }
    if (<MySharedDataCoinInfo>[] is M) {
      return data
          .map<MySharedDataCoinInfo>(
              (Map<String, dynamic> e) => MySharedDataCoinInfo.fromJson(e))
          .toList() as M;
    }
    if (<MySharedDataShareArticles>[] is M) {
      return data
          .map<MySharedDataShareArticles>(
              (Map<String, dynamic> e) => MySharedDataShareArticles.fromJson(e))
          .toList() as M;
    }
    if (<MyTodoDataEntity>[] is M) {
      return data
          .map<MyTodoDataEntity>(
              (Map<String, dynamic> e) => MyTodoDataEntity.fromJson(e))
          .toList() as M;
    }
    if (<MyTodoDataItem>[] is M) {
      return data
          .map<MyTodoDataItem>(
              (Map<String, dynamic> e) => MyTodoDataItem.fromJson(e))
          .toList() as M;
    }
    ...
    if (<ProjectListDataItemEntity>[] is M) {
      return data
          .map<ProjectListDataItemEntity>(
              (Map<String, dynamic> e) => ProjectListDataItemEntity.fromJson(e))
          .toList() as M;
    }
    if (<ProjectListDataDatasTags>[] is M) {
      return data
          .map<ProjectListDataDatasTags>(
              (Map<String, dynamic> e) => ProjectListDataDatasTags.fromJson(e))
          .toList() as M;
    }
