import 'package:network/generated/json/base/json_convert_content.dart';
...
ProjectListDataEntity $ProjectListDataEntityFromJson(
  ...
  final List<ProjectListDataItemEntity>? datas =
      (json['datas'] as List<dynamic>?)
          ?.map((e) => jsonConvert.convert<ProjectListDataItemEntity>(e)
              as ProjectListDataItemEntity)
          .toList();
  if (datas != null) {
...
ProjectListDataItemEntity $ProjectListDataDatasFromJson(
    Map<String, dynamic> json) {
  final ProjectListDataItemEntity projectListDataDatas =
  ...
  final List<ProjectListDataDatasTags>? tags = (json['tags'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<ProjectListDataDatasTags>(e)
          as ProjectListDataDatasTags)
      .toList();
  if (tags != null) {
...
Map<String, dynamic> $ProjectListDataDatasToJson(
...
ProjectListDataDatasTags $ProjectListDataDatasTagsFromJson(
    Map<String, dynamic> json) {
  final ProjectListDataDatasTags projectListDataDatasTags =
