...
import 'package:network/bean/my_todo_data_entity.dart';
...
MyTodoDataEntity $MyTodoDataEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<MyTodoDataItem>? datas = (json['datas'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<MyTodoDataItem>(e) as MyTodoDataItem)
      .toList();
  if (datas != null) {
...
MyTodoDataItem $MyTodoDataDatasFromJson(Map<String, dynamic> json) {
  ...
  final String? completeDateStr =
      jsonConvert.convert<String>(json['completeDateStr']);
