...
import 'package:network/bean/my_shared_data_entity.dart';
...
MySharedDataEntity $MySharedDataEntityFromJson(Map<String, dynamic> json) {
  ...
  final MySharedDataCoinInfo? coinInfo =
      jsonConvert.convert<MySharedDataCoinInfo>(json['coinInfo']);
  if (coinInfo != null) {
    mySharedDataEntity.coinInfo = coinInfo;
  }
  final MySharedDataShareArticles? shareArticles =
      jsonConvert.convert<MySharedDataShareArticles>(json['shareArticles']);
...
MySharedDataShareArticles $MySharedDataShareArticlesFromJson(
  ...
  final MySharedDataShareArticles mySharedDataShareArticles =
