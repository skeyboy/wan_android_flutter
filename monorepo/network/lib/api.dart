...
extension ApiPath on Api {
  Future<AppResponse<ArticleDataEntity>> fetchHomePageArticle(int pageIndex) {
    return get<ArticleDataEntity>("${Api.homePageArticle}$pageIndex/json");
  }

  static Future<AppResponse<T>> get<T>(String url,
      {Object? data,
    ...
    return await HttpGo.instance.get<T>(url,
        data: data,
  ...
  static Future<AppResponse<T>> _post<T>(String url,
      {Object? data,
      Map<String, dynamic>? queryParams,
      CancelToken? cancelToken,
      Options? options,
      ProgressCallback? progressCallback,
      ProgressCallback? receiveCallback}) async {
    return await HttpGo.instance.post(url,
        data: data,
        queryParams: queryParams,
        cancelToken: cancelToken,
        options: options,
